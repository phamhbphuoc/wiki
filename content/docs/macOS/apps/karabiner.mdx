...
### Example 4: Using a US layout keyboard macbook and a JIS external keyboard together

I created [custom rules](https://github.com/phamhbphuoc/karabiner/blob/main/us_to_jis_converter.json) to enable using mac US layout keyboard and external JIS keyboard together on karabiner
...
- [My full karabiner json](https://github.com/phamhbphuoc/karabiner/blob/main/karabiner.json)